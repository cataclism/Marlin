...
#define STRING_CONFIG_H_AUTHOR "(cataclism, Sidewinder X1 SKR 1.4 Turbo)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Sidewinder X1
  #define DEFAULT_bedKp 45.18
  #define DEFAULT_bedKi 5.95
  #define DEFAULT_bedKd 228.81
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 420.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 33.5, -39, 0 }
//MY CONFIGURATION: (33.5,-39,0)
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (58*60)
