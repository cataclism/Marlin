...
#define STRING_CONFIG_H_AUTHOR "(Cataclism, Rock3Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MINGDA Rock3 Pro"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 411.5 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 50, 28, 0 }

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 30

// X and Y axis travel speed (mm/m) between probes
#define XY_PROBE_SPEED (110*60)
